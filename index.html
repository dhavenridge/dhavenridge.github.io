...
<head>
    ...
    <meta name="description"
        content="Shop Floor Automation helps manufacturers modernize operations: CNC connectivity, MES integrations, and on-demand staff augmentation for manufacturing IT projects." />
    <meta property="og:title" content="Shop Floor Automation — Manufacturing IT & Staff Augmentation" />
    <meta property="og:description"
        content="On-demand engineers and developers for your plant IT projects. CNC data, MES/ERP, IIoT, and automation—delivered." />
    ...
    <style>
        ...
        * {
        ...
        .card {
            background: linear-gradient(180deg, var(--card), rgba(16, 26, 43, .7));
            border: 1px solid rgba(255, 255, 255, .06);
        ...
        .highlight {
            background: linear-gradient(180deg, rgba(78, 161, 255, .18), rgba(78, 161, 255, .06));
        ...
        .cta-band {
            padding: 36px;
            border-radius: var(--radius);
            background: linear-gradient(90deg, rgba(46, 182, 125, .22), rgba(78, 161, 255, .22));
            display: flex;
            align-items: center;
            justify-content: space-between;
            gap: 16px;
    ...
    <main>
        ...
        <section id="staff-aug" class="container">
            <div class="card highlight">
                ...
                <p class="kicker">Add vetted engineers and developers to your team—only when you need them. Our people
                    understand plants, controls, and production realities.</p>
      ...
      <div class="grid cols-3" style="margin-top: 18px;">
        ...
        <section id="contact" class="container" style="margin-top:20px;">
            <h2>Get a quote</h2>
            <p class="kicker">Tell us what you’re tackling—connectivity, MES, dashboards, or a team boost. We’ll reply
                with a short plan and pricing.</p>
                ...
                <form id="quote-form" class="card" onsubmit="return submitForm(event)">
                    ...
                    <label>
                        ...
                        <textarea name="details" rows="5"
                            placeholder="What machines, systems, timelines, outcomes?"></textarea>
                    </label>
                    <button class="btn" type="submit">Send request</button>
                    <p id="form-result" class="small" role="status" aria-live="polite" style="display:none; margin:0;">
                    </p>
                </form>
                <div class="card">
                    <h3>Prefer email or a call?</h3>
                    <p>Reach us at <a href="mailto:sales@shopfloorautomation.net">sales@shopfloorautomation.net</a>.
                        We’re in U.S. Central Time.</p>
